    ...
    try:
        ...
        if winerror == 1314 or (is_windows() and exc.errno in (1, 13)):  # EPERM / EACCES
            print(
                ...
                "  - Or use 'sync_mode = \"copy\"' in project agent.toml for copy-based synchronization.",
                file=sys.stderr,
            )
...
def is_developer_mode_enabled() -> bool | None:
    ...
    try:
        ...
        # Fallback: test if a temporary symlink can be created
        return None
