...
other stale content remains a conflict. Unselected project-owned skills can
coexist under `.agents/skills/`; selected-name collisions require review.
Do not store unrelated files under `.agents/memory/`, which Aikito owns exclusively.
